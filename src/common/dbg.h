...
inline std::string dump_as_hex_bytes(const crypto::public_key& key)
{
  return tools::dump_as_hex_bytes((const u8*)key.data, 32);
}

inline std::string dump_as_hex_bytes(const crypto::key_derivation& key)
{
  return tools::dump_as_hex_bytes((const u8*)key.data, 32);
}
/////////////////////////////////////////////////////////////////////////////////////////
